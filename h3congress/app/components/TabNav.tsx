...
export default function TabNav() {
  ...
  // Download the pre-built data bundle (CSVs of the "H1 & H3" and "H2 Problem
  // Space" tabs, zipped). The bundle is regenerated by scripts/fetch-sheet.mjs
  // on every Google Sheet pull, so this always serves the latest data.
  const handleExport = () => {
    const link = document.createElement("a");
    link.href = "/exports/h3-congress-data.zip";
    link.download = "h3-congress-data.zip";
  ...
  return (
    <nav className="h3-nav h3-tab-nav" aria-label="Primary navigation">
      ...
      <div className="h3-nav-links h3-tab-links">
        ...
        <button type="button" className="h3-nav-export" onClick={handleExport}>
          <svg
            width="15"
            height="15"
            viewBox="0 0 24 24"
